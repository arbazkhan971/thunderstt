...
// vad_stub.go provides type definitions and a no-op VAD implementation for
// builds without CGo. This lets the rest of the pipeline package compile
// even when the sherpa-onnx native libraries are not available.
